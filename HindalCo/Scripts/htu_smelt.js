...
window.addEventListener('DOMContentLoaded', function() {
    ...
    var createScene = function() {
        ...
        BABYLON.SceneLoader.Append("/Assets/", "Halllway.glb", scene, function (scene) {
            ...
            addCollisionToMesh(scene, "71HTU_Low.002");
    ...
    var resetPlayerPosition = function(camera) {
        camera.position = new BABYLON.Vector3(-0.18, -12.9, -7.88);
        camera.rotation = new BABYLON.Vector3(0, -0.01, 0); // Adjust rotation as needed
    };
